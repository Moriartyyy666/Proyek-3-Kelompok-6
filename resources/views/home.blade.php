...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light" style="background-color: #c5769f;">
        <div class="container">
            <a class="navbar-brand" href="#beranda">
                <img src="assets/img/logo-lalsstore.png" alt="Logo" width="60" height="54"
    ...
    <header class="py-5 d-flex align-items-center position-relative" id="beranda"
        style="min-height: 90vh; background-image: url('assets/img/bglanding.jpeg'); background-size: cover; background-position: center;">
        <div class="overlay"
            style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.5); backdrop-filter: blur(7px);">
        </div>
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-6 text-center">
                    <div>
                        ...
                        <p class="lead text-white mb-4">Toko online yang menjual akun premium private untuk berbagai
                            layanan digital</p>
                    ...
                    <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                            ...
                            <div class="feature bg-gradient text-white rounded-3 me-3"
                                ...
                                <img src="assets/img/netflixlogo.png" alt="Netflix Logo" width="40" height="40">
                            </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingTwo">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div class="feature bg-gradient text-white rounded-3 me-3"
                                style="background-color: #e48dba; width: 55px; height: 55px;">
                                <img src="assets/img/viulogo.jpg" alt="Viu Logo" width="40" height="40">
                            </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingThree">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div class="feature bg-gradient text-white rounded-3 me-3"
                                style="background-color: #e48dba; width: 55px; height: 55px;">
                                <img src="assets/img/spotifylogo.png" alt="Spotify Logo" width="40"
                                    height="40">
                            </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingFour">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div class="feature bg-gradient text-white rounded-3 me-3"
                                style="background-color: #e48dba; width: 55px; height: 55px;">
                                <img src="assets/img/canvalogo.png" alt="Canva Logo" width="38" height="38">
                            </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingFive">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div class="feature bg-gradient text-white rounded-3 me-3"
                                style="background-color: #e48dba; width: 55px; height: 55px;">
                                <img src="assets/img/picsartlogo.png" alt="Picsart Logo" width="37"
                                    height="37">
                            </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingSix">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div class="feature bg-gradient text-white rounded-3 me-3"
                                style="background-color: #e48dba; width: 55px; height: 55px;">
                                <img src="assets/img/vscologo.png" alt="VSCO Logo" width="40" height="40">
                            </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingSeven">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div class="feature bg-gradient text-white rounded-3 me-3"
                                style="background-color: #e48dba; width: 55px; height: 55px;">
                                <img src="assets/img/zoomlogo.png" alt="Zoom Logo" width="49" height="49">
                            </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingEight">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <div class="feature bg-gradient text-white rounded-3 me-3"
                                style="background-color: #e48dba; width: 55px; height: 55px;">
                                <img src="assets/img/chatgptlogo.png" alt="ChatGPT Logo" width="39"
                                    height="39">
                            </div>
